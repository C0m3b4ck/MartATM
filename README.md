...
# MartATM
A legacy-compatible ATM. Frontend in Visual Basic 6.
...
<br>
<br><h2><b>The program will be tested on Windows CE 6 once it is in a useable stage. Windows CE 6 is the intended OS for the program, as most ATMs run it.</b></h2>

# Principles
* Maximum speed, ease-of-use and efficiency
* Security
* Easy installation and portability - no dependencies need to be installed by system admin
